...
{
	if (region.bd.I === region._.I)
	{
		return 'on line ' + region.bd.I;
	}
	return 'on lines ' + region.bd.I + ' through ' + region._.I;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a3, request.aL, true);
		} catch (e) {
...
var $author$project$Main$EmptyPage = {$: 0};
...
var $author$project$Video$Video = F2(
	function (youTubeId, path) {
		return {ap: path, bn: youTubeId};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Main$decodePath = A2(
...
var $author$project$Main$decodeYouTubeId = A2($elm$json$Json$Decode$field, 'video_vid', $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$index = _Json_decodeIndex;
var $author$project$Main$decodeVideo = A2(
	$elm$json$Json$Decode$index,
	0,
	A3($elm$json$Json$Decode$map2, $author$project$Video$Video, $author$project$Main$decodeYouTubeId, $author$project$Main$decodePath));
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aR: false, aT: r.aT, ab: r.ab, af: r.af, a3: r.a3, bi: r.bi, aJ: r.aJ, aL: r.aL}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aT: $elm$http$Http$emptyBody, ab: r.ab, af: _List_Nil, a3: 'GET', bi: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aL: r.aL});
};
var $author$project$Main$GotVideo = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$VideoNotFound = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$resultToMsg = F2(
	function (id, result) {
		if (((result.$ === 1) && (result.a.$ === 3)) && (result.a.a === 404)) {
			return $author$project$Main$VideoNotFound(id);
		} else {
			return $author$project$Main$GotVideo(
	...
	return $elm$http$Http$get(
		{
			ab: A2(
				...
				$author$project$Main$resultToMsg(id),
				$author$project$Main$decodeVideo),
			aL: A2(
				...
				_List_fromArray(
					[
						A2($elm$url$Url$Builder$string, 'vid', id)
					]))
		});
};
...
var $author$project$Main$urlParseYouTubeId = function (str) {
	return A2(
		$elm$core$Maybe$withDefault,
		$elm$core$Maybe$Nothing,
		A2(
...
var $author$project$Main$parseYouTubeId = function (urlString) {
	return A2(
		$elm$core$Maybe$andThen,
		$author$project$Main$urlParseYouTubeId,
		$elm$url$Url$fromString(urlString));
};
var $author$project$Main$init = function (videoURL) {
	var _v0 = $author$project$Main$parseYouTubeId(videoURL);
	if (!_v0.$) {
		var id = _v0.a;
		return _Utils_Tuple2(
			{q: $author$project$Main$EmptyPage, w: $krisajenkins$remotedata$RemoteData$Loading},
			$author$project$Main$getVideo(id));
	} else {
		return _Utils_Tuple2(
			{q: $author$project$Main$EmptyPage, w: $krisajenkins$remotedata$RemoteData$NotAsked},
...
var $author$project$Main$CreatedVideo = function (a) {
	return {$: 1, a: a};
};
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{aT: r.aT, ab: r.ab, af: _List_Nil, a3: 'POST', bi: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aL: r.aL});
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$createVideo = function (id) {
	return $elm$http$Http$post(
		{
			...
			ab: $elm$http$Http$expectWhatever(
				A2(
					...
					A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$CreatedVideo))),
			aL: A2(
				$author$project$Api$url,
				_List_fromArray(
					['videos']),
...
var $author$project$Page$ListWarnings$CreatedAutomatedWarnings = function (a) {
	return {$: 4, a: a};
};
var $author$project$Page$ListWarnings$createAutomatedWarnings = function (path) {
	return $elm$http$Http$post(
		{
			aT: $elm$http$Http$emptyBody,
			ab: $elm$http$Http$expectWhatever(
				A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Page$ListWarnings$CreatedAutomatedWarnings)),
			aL: A2(
				$author$project$Api$url,
				_Utils_ap(
					path,
...
var $author$project$Page$ListWarnings$init = function (path) {
	return _Utils_Tuple2(
		{ap: path, O: $krisajenkins$remotedata$RemoteData$Loading, P: $krisajenkins$remotedata$RemoteData$NotAsked},
		$author$project$Page$ListWarnings$createAutomatedWarnings(path));
};
var $author$project$Page$NewWarning$init = function (path) {
	return _Utils_Tuple2(
		{aW: '', x: $elm$core$Maybe$Nothing, ap: path, B: $krisajenkins$remotedata$RemoteData$NotAsked, bd: '', bg: ''},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Warning$Automated = 0;
var $author$project$Warning$UserGenerated = 1;
var $author$project$Warning$Warning = F4(
	function (start, stop, description, source) {
		return {aW: description, bc: source, bd: start, bg: stop};
	});
...
var $author$project$Time$fromInt = function (i) {
	return {
		J: (i / 60) | 0,
		C: A2($elm$core$Basics$modBy, 60, i)
	};
};
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Page$ListWarnings$decodeWarning = function () {
	var stringToSourceDecoder = function (s) {
		switch (s) {
			case 'AUTO':
			...
			default:
				return $elm$json$Json$Decode$fail('Invalid warning source');
		}
	};
	var decodeSource = A2($elm$json$Json$Decode$andThen, stringToSourceDecoder, $elm$json$Json$Decode$string);
	return A5(
		$elm$json$Json$Decode$map4,
		$author$project$Warning$Warning,
		A2(
			$elm$json$Json$Decode$map,
			$author$project$Time$fromInt,
			A2($elm$json$Json$Decode$field, 'warning_start', $elm$json$Json$Decode$int)),
		A2(
			$elm$json$Json$Decode$map,
			$author$project$Time$fromInt,
			A2($elm$json$Json$Decode$field, 'warning_end', $elm$json$Json$Decode$int)),
		A2($elm$json$Json$Decode$field, 'warning_description', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'warning_source', decodeSource));
}();
			...
			case 4:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{O: status}),
					A2($author$project$Page$ListWarnings$getWarnings, model.ap, $elm$core$Maybe$Nothing));
			case 3:
				var warnings = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Time$toInt = function (t) {
	return (t.J * 60) + t.C;
};
						...
						_List_fromArray(
							[
								...
								$elm$json$Json$Encode$int(
									$author$project$Time$toInt(warning.bd))),
								_Utils_Tuple2(
								'stop',
								$elm$json$Json$Encode$int(
									$author$project$Time$toInt(warning.bg))),
								_Utils_Tuple2(
								'description',
								$elm$json$Json$Encode$string(warning.aW))
							]))),
				ab: $elm$http$Http$expectWhatever(
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {Y: col, aV: contextStack, as: problem, aC: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aC, s.Y, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{Y: 1, c: s.c, d: s.d, b: s.b + 1, aC: s.aC + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{Y: s.Y + 1, c: s.c, d: s.d, b: newOffset, aC: s.aC, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{Y: col, c: s0.c, d: s0.d, b: offset, aC: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aC, s.Y, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {Y: col, as: problem, aC: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aC, p.Y, p.as);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{Y: 1, c: _List_Nil, d: 1, b: 0, aC: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aC, s.Y, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{Y: newCol, c: s.c, d: s.d, b: newOffset, aC: newRow, a: s.a});
	};
};
...
var $author$project$Time$fromString = function (str) {
	var time = F2(
		function (min, sec) {
			var _v1 = _Utils_Tuple2(
				$elm$core$String$toInt(min),
				$elm$core$String$toInt(sec));
			if ((!_v1.a.$) && (!_v1.b.$)) {
				var m = _v1.a.a;
				var s = _v1.b.a;
				return (s < 60) ? $elm$core$Maybe$Just(
					{J: m, C: s}) : $elm$core$Maybe$Nothing;
			} else {
				return $elm$core$Maybe$Nothing;
			}
		});
	var minutes = $elm$parser$Parser$getChompedString(
		A2(
			$elm$parser$Parser$ignorer,
			$elm$parser$Parser$succeed(0),
			$elm$parser$Parser$chompWhile($elm$core$Char$isDigit)));
	var digit = $elm$parser$Parser$getChompedString(
		A2(
			$elm$parser$Parser$ignorer,
			$elm$parser$Parser$succeed(0),
	...
	var parser = A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed(time),
				$elm$parser$Parser$spaces),
			A2(
				$elm$parser$Parser$ignorer,
				minutes,
				$elm$parser$Parser$symbol(':'))),
		A2($elm$parser$Parser$ignorer, seconds, $elm$parser$Parser$spaces));
	var _v0 = A2($elm$parser$Parser$run, parser, str);
	if ((!_v0.$) && (!_v0.a.$)) {
		var t = _v0.a.a;
...
var $author$project$Page$NewWarning$update = F2(
	function (msg, model) {
		...
		while (true) {
			switch (_v0.a.$) {
				case 0:
					if (((_v0.a.a.$ === 2) && (_v0.a.a.a.$ === 3)) && (_v0.a.a.a.a === 400)) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
				...
				case 1:
					if (!_v0.b.$) {
						...
						var _v3 = _Utils_Tuple2(
							$author$project$Time$fromString(model.bd),
							$author$project$Time$fromString(model.bg));
						if (!_v3.a.$) {
							if (!_v3.b.$) {
								var start = _v3.a.a;
								var stop = _v3.b.a;
						...
						switch (_v0.a.a.$) {
							case 3:
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{w: $krisajenkins$remotedata$RemoteData$Loading}),
									$author$project$Main$getVideo(id));
							case 2:
								var e = _v0.a.a.a;
								var _v3 = _v0.b;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{w: $krisajenkins$remotedata$RemoteData$NotAsked}),
									$elm$core$Platform$Cmd$none);
							default:
								break _v0$8;
						}
					...
					if (!_v0.b.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{w: $krisajenkins$remotedata$RemoteData$Loading}),
							$author$project$Main$createVideo(id));
					} else {
						break _v0$8;
					}
				case 3:
					if (_v0.b.$ === 1) {
						...
						var _v5 = A2($author$project$Page$ListWarnings$update, subMsg, pageModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									q: $author$project$Main$ListPage(updatedPageModel)
								}),
					...
					if (_v0.b.$ === 2) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									q: $author$project$Main$NewPage(updatedPageModel)
								}),
...
var $author$project$Page$ListWarnings$viewStatus = function (status) {
	if (status.$ === 3) {
		return _List_Nil;
	} else {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Error$view('Video is still being screened')
					]))
			]);
	}
};
...
var $author$project$Time$toString = function (t) {
	var seconds = (t.C < 10) ? ('0' + $elm$core$String$fromInt(t.C)) : $elm$core$String$fromInt(t.C);
	return $elm$core$String$fromInt(t.J) + (':' + seconds);
};
var $elm$html$Html$tr = _VirtualDom_node('tr');
var $author$project$Page$ListWarnings$viewWarning = function (warning) {
	var sourceToString = function (s) {
		if (!s) {
			return 'Automated';
		} else {
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Time$toString(warning.bd))
									]))
							])),
						A2(
						$elm$html$Html$tr,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Time$toString(warning.bg))
									]))
							])),
						A2(
						$elm$html$Html$tr,
	...
	return $elm$core$List$isEmpty(warnings) ? A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('no-warnings')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('No warnings to display')
					]))
			])) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			...
			return A2(
				...
				_Utils_ap(
					_List_fromArray(
						[$author$project$Page$ListWarnings$viewMenu]),
					_Utils_ap(
						$author$project$Page$ListWarnings$viewStatus(model.O),
						_List_fromArray(
							[
...
var $author$project$Page$NewWarning$timeInput = F2(
	function (v, toMsg) {
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$pattern('[0-9]*:[0-5][0-9]'),
					$elm$html$Html$Attributes$placeholder('mm:ss'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Page$NewWarning$viewError(model.x),
						A2(
						$elm$html$Html$label,
						_List_Nil,
						_List_fromArray(
						...
						A2($author$project$Page$NewWarning$timeInput, model.bd, $author$project$Page$NewWarning$InputStart),
						A2(
						$elm$html$Html$label,
						_List_Nil,
						_List_fromArray(
						...
						A2($author$project$Page$NewWarning$timeInput, model.bg, $author$project$Page$NewWarning$InputStop),
						A2(
						$elm$html$Html$label,
						_List_Nil,
						_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$ClickList(video.ap))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Show Warnings')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$ClickNew(video.ap))
							]),
						_List_fromArray(
							[
...
var $author$project$Main$view = function (model) {
	var _v0 = _Utils_Tuple2(model.q, model.w);
	switch (_v0.b.$) {
		case 1:
			var _v1 = _v0.b;
			return A2(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{a1: $author$project$Main$init, bh: $author$project$Main$subscriptions, bk: $author$project$Main$update, bl: $author$project$Main$view});
